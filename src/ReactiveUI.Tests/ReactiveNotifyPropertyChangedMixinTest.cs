...
namespace ReactiveUI.Tests
{
    ...
    public class WhenAnyObservableTests
    {
        ...
        {
            var fixture = new TestWhenAnyObsViewModel();
            fixture.WhenAnyObservable(x => x.MyListOfInts.ToObservableChangeSet().CountChanged()).ToObservableChangeSet(ImmediateScheduler.Instance).Bind(out var output).Subscribe();
